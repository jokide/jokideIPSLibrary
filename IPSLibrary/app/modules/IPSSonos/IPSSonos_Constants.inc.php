<?
	...
	define ('IPSSONOS_FNC_MSGTTSRS',					'MSGTTSRS');	
	define ('IPSSONOS_FNC_MSGTTSAS',					'MSGTTSAS');	
	define ('IPSSONOS_FNC_MSGGEN',						'MSGGEN');	
	...
	define ('IPSSONOS_VAR_TTSID',						'TTSID');
	define ('IPSSONOS_VAR_LPATH',						'LPATH');
	define ('IPSSONOS_VAR_SMBPATH',						'SMBPATH');
	define ('IPSSONOS_VAR_SOUNDS',						'SOUNDS');	
